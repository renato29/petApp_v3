...
// This is the dashboard to add Pet in list
const AdmDash = () => {
...
const addToList = () => { 
        ...
        { status: status, name: name, breed: breed, height:height, weight: weight, color:color, type: type,diet: diet, alergy: alergy,bio:bio })
    }
    ...
    return (
        <>
            <div className="container rounded bg-white mt-5">
                    ...
                    <div className="col-md-8">
                        <div className="p-3 py-5">
                            <div className="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <Link to="/login"><h6>Back to home</h6></Link>
                                </div>
                ...
                return <div key={key} className=' p-3 buddyCard'> {
                            <>
